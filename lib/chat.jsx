...
export default function Chat() {
  ...
  }, [messageLog]) /*anytime messageLog runs do this scroll to bottom*/

  function openChatClick() {
    setIsChatOpen(true)
    setUnreadCount(0)
    setTimeout(() => {
      chatField.current.focus() /*useRef like .querySelector in vanilla*/
    }, 350)
  }
  ...
  return (
    <>
      <div className="open-chat" onClick={openChatClick}>
        {unreadCount > 0 && <span className="chat-unread-badge">{unreadCount}</span>} <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-chat-text-fill" viewBox="0 0 16 16">
